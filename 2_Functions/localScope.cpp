...
int add(int x, int y) // x and y are created and enter scope here
{
    ...
    return x + y;
} // y and x go out of scope and are destroyed here(see the order here)
...
/* In modern C++, the best practice is that local variables inside the function body 
...
/* Temporary objects have no scope at all (this makes sense, since scope is a property of an identifier, 
and temporary objects have no identifier). */